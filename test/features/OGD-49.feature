# language: de
Funktionalität: Als Datenlieferant (technisch) möchte ich zu einem Datensatz meiner Organisation über ein Web-Frontend Metadaten erfassen und bearbeiten können, so dass dieser Datensatz ohne zusätzliche Investitionen über das Portal zugänglich ist. (OGD-49)

  Grundlage:
    Gegeben sei ein Admin-Back-End genannt Admin
