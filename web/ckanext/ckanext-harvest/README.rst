=============================================
ckanext-ftpharvest - FTP harvesting extension
=============================================

.. image:: https://travis-ci.org/ckan/ckanext-harvest.svg?branch=master
    :target: https://travis-ci.org/ckan/ckanext-harvest

A modification of the ckan_harvest extension to gather files from FTP sources.

Installation (from ckan_harvest extension)
==========================================
