...
define( 'WP_HOME', 'http://ogdch-abnahme.clients.liip.ch' );
define( 'WP_SITEURL', 'http://ogdch-abnahme.clients.liip.ch/cms' );
...
define( 'CKAN_API_ENDPOINT', 'http://ogdch-abnahme.clients.liip.ch/api/3/action/' );
...
define( 'PIWIK_URL', 'ogdch-piwik-abnahme.clients.liip.ch' );
